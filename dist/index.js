...
// import Alpine from './node_modules/alpinejs/src/alpine.js';
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _alpinejs = require("alpinejs");
var _alpinejsDefault = parcelHelpers.interopDefault(_alpinejs);
// const Alpine=require('./node_modules/alpinejs/src/alpine');
...
directive("model", (el, { modifiers, expression }, { effect: effect3, cleanup: cleanup2 })=>{
    ...
    if (modifiers.includes("fill")) {
        if ([
            ...
            null,
            ""
        ].includes(getValue()) || el.type === "checkbox" && Array.isArray(getValue()) || el.tagName.toLowerCase() === "select" && el.multiple) setValue(getInputValue(el, modifiers, {
            target: el
        }, getValue()));
    }
...
},{}]},["km5uZ","bB7Pu"], "bB7Pu", "parcelRequiref9cf")
